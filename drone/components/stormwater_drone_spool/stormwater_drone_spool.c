...
mcpwm_timer_config_t timer_0_config = {
    ...
    .period_ticks = 20000, // ticks per period - at 20k should create 50Hz PWM
                           // with 20000 microsecond duty cycle
    .intr_priority = 0,
...
static void srv_init(void) {
  ...
  mcpwm_generator_set_action_on_timer_event(
      generator_0, MCPWM_GEN_TIMER_EVENT_ACTION(MCPWM_TIMER_DIRECTION_UP,
  ...
  mcpwm_generator_set_action_on_compare_event(
      generator_0, MCPWM_GEN_COMPARE_EVENT_ACTION(
                       MCPWM_TIMER_DIRECTION_UP, cmpr_0, MCPWM_GEN_ACTION_LOW));
...
int stormwater_drone_spool_get_pos_ticks(void) { return pos_ticks; }
