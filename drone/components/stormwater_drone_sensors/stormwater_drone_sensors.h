#ifndef STORMWATER_DRONE_SENSORS_H
#define STORMWATER_DRONE_SENSORS_H
...
void stormwater_drone_sensors_init(void);
float stormwater_drone_sensors_get_temp(void);
float stormwater_drone_sensors_get_d_o2(void);
float stormwater_drone_sensors_get_ph(void);
