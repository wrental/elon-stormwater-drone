 ...
 */
#define SENS_TEMP (GPIO_NUM_1)
#define SENS_D_O2 (GPIO_NUM_2)
#define SENS_PH (GPIO_NUM_3)
#define OUT_PUMP (GPIO_NUM_4)
// 5 - NC
// 6 - NC
...
#define ENC_DAT_A (GPIO_NUM_9)
#define ENC_DAT_B (GPIO_NUM_10)
