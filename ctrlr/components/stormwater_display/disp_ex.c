...
static const uint8_t char_data[] = {0x04, 0x0e, 0x0e, 0x0e, 0x1f, 0x00,
                                    0x04, 0x00, 0x1f, 0x11, 0x0a, 0x04,
                                    0x0a, 0x11, 0x1f, 0x00};
...
void lcd_test(void *pvParameters) {
  ...
  ESP_ERROR_CHECK(pcf8574_init_desc(&pcf8574, CONFIG_EXAMPLE_I2C_ADDR, 0,
...
void app_main() {
  ...
  xTaskCreate(lcd_test, "lcd_test", configMINIMAL_STACK_SIZE * 5, NULL, 5,
              NULL);
}
